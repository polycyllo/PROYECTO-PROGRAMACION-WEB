...
export default function Formulario({
    ...
    const handleGuardarClick = async () => {
        ...
        if (formElement) {
            ...
            // Llamar al servicio para agregar el formulario
            try {
    ...
    return (
        ...
        <form className="pt-24" onSubmit={handleSubmit(handleGuardarClick)}>
            ...
            <input
                        ...
                        className={`min-w-96 md:w-1/2 border ${errors.nombreformulario ? "border-red-600" : "border-gray-600"} mx-auto rounded-lg focus:outline-none p-2 font-bold`}
                ...
                <input
                    ...
                    className={`min-w-96 md:w-1/2 border ${errors.descripcion?"border-red-600" :"border-gray-600"} mx-auto rounded-lg focus:outline-none p-2 font-medium`}
