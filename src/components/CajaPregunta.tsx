...
export default function CajaPregunta({
    ...
    useEffect(() => {
        if (
            ...
            tipoRespuesta !== "varias_respuestas"
        ) {
        ...
        <div className="caja mx-5 px-5 bg-[#00AFFF] rounded-xl">
            <div className="flex flex-row items-center justify-between">
                <div className="w-full">
                    ...
                    >
                        ...
                        <option value="varias_respuestas">
                            Varias respuestas
                        </option>
                        <option value="respuesta_parrafo">
                            Respuesta/parrafo{" "}
                        </option>
            ...
            <div className=" pb-5">
                {cajaRespuesta.map((respuesta, respIndex) => (
                    <div
                        key={respuesta.id}
                        className="borde p-4 rounded-2xl flex"
                    >
                        <input
                            ...
                            <>
                                <label className="ml-4 flex items-center gap-2">
                                    <input
                                        ...
                                        value="true"
                                        className={`appearance-none h-6 w-6 border-4 border-black ${
                                            tipoRespuesta ===
                                            "varias_respuestas"
                                                ? ""
                                                : "rounded-full"
                                        } checked:bg-white focus:outline-none`}
                                    />
                                </label>
